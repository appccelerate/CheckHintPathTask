...
namespace Appccelerate.CheckHintPathTask
{
    ...
    public class ProjectBuilder : IReferences
    {
        ...
        public IReferences WithReferences()
        {
            return this;
        }

        public IReferences AddReference(string id)
        {
            this.references.Add("<Reference Include=\"" + id + "\" />");
            return this;
        }

        public IReferences AddReference(string id, string hintPath)
        {
            this.references.Add("<Reference Include=\"" + id + "\"><HintPath>" + hintPath + "</HintPath></Reference>");
            return this;
        }
...
<Project ToolsVersion=""12.0"" DefaultTargets=""Build"" xmlns=""http://schemas.microsoft.com/developer/msbuild/2003"">
  ...
  -->
    ...
    {
        IReferences WithReferences();

        XDocument Build();
    }

    public interface IReferences : IProjectBuilder
    {
